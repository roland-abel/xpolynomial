...
namespace xmath {
    ...
    public:
        ...
        static constexpr polynomial<T> monomial(size_type degree, value_type coeff = static_cast<value_type>(1));
        ...
        static constexpr polynomial<T> from_roots(const values_type &roots);
        ...
        constexpr polynomial<T> normalize() const;
        ...
        constexpr bool operator==(const polynomial<T> &p) const;
        ...
        constexpr polynomial<T> &operator+=(value_type scalar);
        ...
        constexpr polynomial<T> operator+(const polynomial<T> &p) const;
        ...
        constexpr polynomial<T> &operator+=(const polynomial<T> &p);
        ...
        constexpr std::tuple<polynomial<T>, polynomial<T>> divide(const polynomial<T> &divisor) const;
        ...
        constexpr polynomial compose(const polynomial<T> &q) const;
        ...
        [[nodiscard]] constexpr bool is_root(const value_type &value) const;
        ...
        [[nodiscard]] constexpr bool has_roots(const values_type &values) const;
    ...
    private:
        ...
        explicit constexpr polynomial(size_type degree);

        /// @brief Trims leading zero coefficients from the polynomial.
        constexpr polynomial<T> &trim_coefficients();

        /// @brief Checks if two values are nearly equal within a small epsilon.
        static constexpr bool nearly_equal(value_type a, value_type b);

        /// @brief Checks if a value is nearly zero within a small epsilon.
        static constexpr bool nearly_zero(value_type a);
